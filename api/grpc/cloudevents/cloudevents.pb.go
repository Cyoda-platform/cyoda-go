...
// Adjusted go_package for cyoda-go module.
...
func (x *CloudEvent_CloudEventAttributeValue) Reset() {
	*x = CloudEvent_CloudEventAttributeValue{}
	mi := &file_cloudevents_cloudevents_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudEvent_CloudEventAttributeValue) Descriptor() ([]byte, []int) {
	return file_cloudevents_cloudevents_proto_rawDescGZIP(), []int{0, 1}
}
...
const file_cloudevents_cloudevents_proto_rawDesc = "" +
	"\n" +
	"\x1dcloudevents/cloudevents.proto\x12\x11io.cloudevents.v1\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcf\x05\n" +
	"\n" +
	"CloudEvent\x12\x0e\n" +
	...
	"\x06events\x18\x01 \x03(\v2\x1d.io.cloudevents.v1.CloudEventR\x06eventsB9Z7github.com/cyoda-platform/cyoda-go/api/grpc/cloudeventsb\x06proto3"

var (
	file_cloudevents_cloudevents_proto_rawDescOnce sync.Once
	file_cloudevents_cloudevents_proto_rawDescData []byte
)

func file_cloudevents_cloudevents_proto_rawDescGZIP() []byte {
	file_cloudevents_cloudevents_proto_rawDescOnce.Do(func() {
		file_cloudevents_cloudevents_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cloudevents_cloudevents_proto_rawDesc), len(file_cloudevents_cloudevents_proto_rawDesc)))
	})
...
var file_cloudevents_cloudevents_proto_goTypes = []any{
...
func file_cloudevents_cloudevents_proto_init() {
	...
	file_cloudevents_cloudevents_proto_msgTypes[0].OneofWrappers = []any{
		(*CloudEvent_BinaryData)(nil),
		(*CloudEvent_TextData)(nil),
		(*CloudEvent_ProtoData)(nil),
	}
	file_cloudevents_cloudevents_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cloudevents_cloudevents_proto_rawDesc), len(file_cloudevents_cloudevents_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
